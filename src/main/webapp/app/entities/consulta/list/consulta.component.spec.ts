...
describe('Consulta Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'consulta', component: ConsultaComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to consultaService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getConsultaIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getConsultaIdentifier).toHaveBeenCalledWith(entity);
