...
import { EntityArrayResponseType, ConsultaService } from '../service/consulta.service';
...
export class ConsultaComponent implements OnInit {
  ...
  trackId = (_index: number, item: IConsulta): number => this.consultaService.getConsultaIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.consultas = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IConsulta[] | null): IConsulta[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.consultaService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
